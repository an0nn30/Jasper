...
public final class TerminalPainter {
    ...
    public TerminalPainter(FontSet fonts, Palette palette) {
        this.fonts = fonts;
        this.palette = palette;
        this.runs = new RunBuilder(fonts, palette);
    }

    public void paint(Graphics2D g, ScreenSnapshot snapshot, CursorLook cursor, List<Highlight> highlights, int widthPx, int heightPx) {
