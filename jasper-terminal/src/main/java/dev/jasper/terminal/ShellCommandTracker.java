...
final class ShellCommandTracker {
    ...
    ShellCommandTracker(LongSupplier clock, Supplier<CommandLocation> cursor,
    ...
    Optional<Path> workingDirectory() { return Optional.ofNullable(workingDirectory); }
    boolean detected() { return shellIntegrationDetected; }
    void discardUnusedPayload() { pendingCommandText = null; }
