...
class RunBuilderTest {
    ...
    void readCellsPadsWithSpacesAndEmptyStyle() {
        ...
        new JediCellReader().capture(line, 4).readCells(4, chars, styles);
    ...
    void readCellsTurnsNulIntoSpace() {
        ...
        new JediCellReader().capture(line, 3).readCells(3, chars, new CellAttributes[3]);
    ...
    void buildFromTerminalLineCombinesReadAndBuild() {
        ...
        List<Run> runs = builder.build(new JediCellReader().capture(line, 4), 4);
