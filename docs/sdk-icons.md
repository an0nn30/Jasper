...
Prefer semantic names (SDK 0.7.4; SDK 0.7.5 adds SPLIT, ZOOM, TERMINAL and SERVER):
...
`IconName` contains all 26 meanings shown below. Jasper maps each to its own modern SVG
