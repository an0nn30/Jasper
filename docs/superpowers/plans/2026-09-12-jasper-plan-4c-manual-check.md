...
- [ ] Close every window/Quit after theme activity; check no late UI callbacks or errors. Jasper removes its listener; the dependency's process-wide daemon/native observer has no shutdown API.
