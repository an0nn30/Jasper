...
**Spec:** docs/superpowers/specs/2026-09-11-jasper-tab-motion-design.md
...
**Files:** WindowContent.java, WindowChrome.java, WindowTabs.java (height only), MacTitleBar.java, KeyBindings.java, ActionId.java if needed; existing KeyBindingsTest/MacTitleBarTest/WindowTabsTest/MockUiTest and new focused height tests under jasper-app/src/test/java/dev/jasper/app.
