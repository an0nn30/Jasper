...
6. Cmd+F searches emitted text; verify count, next/previous, Case/Regex, invalid regex feedback, Escape returns typing to terminal.
7. Cmd+= / Cmd+- / Cmd+0 changes/reset focused font only. Cmd+K clears history without blanking live screen.
