...
**Spec:** docs/superpowers/specs/2026-09-12-jasper-plan-4b-terminal-config-design.md
...
**Files:** Modify jasper-terminal/src/main/java/dev/jasper/terminal/{TerminalOptions,FontSet,TerminalView}.java; create BellMode.java; focused tests in matching test package. Do not touch jasper-app production files in this task.
...
- [x] Run focused RED/GREEN tests then :jasper-terminal:check and source hygiene; self-review and commit/report exact APIs and results. Root owns spec/plan/STATUS.

### Task 2: Expanded immutable settings, positioned parsing and template
**Files:** Create jasper-app/src/main/java/dev/jasper/app/{FontConfig,TerminalConfig}.java. Modify ConfigSnapshot,ConfigLoader,ConfigTemplate and focused app tests. Reuse Task1 TerminalOptions/BellMode.
...
- [x] Run focused RED/GREEN and :jasper-app:check/hygiene; commit/report. No service or UI integration changes in this task.

### Task 3: Captured launch defaults and initial window sizing
**Files:** Create jasper-app/src/main/java/dev/jasper/app/{LaunchSettings,InitialWindowSize}.java. Modify ShellLauncher,TerminalPane,JasperApplication,TerminalWindow,ConfigurationController and focused tests. Task4 owns full live view application.
**Produces package-private contracts:**
```java
