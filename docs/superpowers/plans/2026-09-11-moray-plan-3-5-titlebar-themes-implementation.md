...
- [x] **Step 4: Verify and commit.** Run `./gradlew :moray-app:check` plus exact focused regressions after fixes. Report APIs, resources, live-update/cleanup behavior and exact test counts. No GUI. Commit source/resources/tests; task review before next task.
