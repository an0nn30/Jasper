...
Pending user execution. Run `./gradlew :jasper-app:run` from `/Users/dustin/projects/moray`. This opens real windows and the user's shell. Agents do not launch it unattended.
