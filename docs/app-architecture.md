...
| `shortcuthelp` | EDT read-only effective shortcut catalog, grouped search table and window-scoped key recorder. Application owns ShortcutHelp; its auxiliary surface owns subscriptions and capture cleanup. |
