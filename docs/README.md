...
- [SFTP phase 1 design](superpowers/specs/2026-09-23-jasper-remote-sftp-design.md): proposed file browser and persistent transfer management within Remote; awaiting written-spec review.
