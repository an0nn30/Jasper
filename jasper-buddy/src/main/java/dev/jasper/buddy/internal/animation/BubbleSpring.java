...
public final class BubbleSpring {
    ...
    public BubbleSpring(double value) { from = target = value; }

    public void target(double value, long now, boolean snap) {
    ...
    public boolean moving(long now) { return (from != target || velocity != 0) && now - started < SETTLE_NANOS; }
}
