...
public final class BubbleMotion {
    public static final long IN_NANOS = TimeUnit.MILLISECONDS.toNanos(600);
    public static final long SETTLE_NANOS = IN_NANOS;
    public static final long HOVER_NANOS = TimeUnit.MILLISECONDS.toNanos(120);
    public static final float IN_TRAVEL = 32f;
     ...
     */
    public static float remaining(long elapsedNanos) {
    ...
    public static float arrivalOffset(long elapsedNanos) { return IN_TRAVEL * remaining(elapsedNanos); }

    public static float hover(long elapsedNanos, boolean entering) {
