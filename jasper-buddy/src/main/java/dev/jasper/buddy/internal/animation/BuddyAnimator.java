 ...
 */
public final class BuddyAnimator {
    ...
    public BuddyAnimator(Random random) { this.random = Objects.requireNonNull(random, "random"); }

    public BuddyFrame frame() { return frame; }
    ...
    public Optional<BuddyFrame> overlay() {
    ...
    public OptionalLong nextDueNanos() {
        return switch (mode) {
