...
class BuddyDeckPanelTest {
    ...
    private BuddyDeckPanel panel() {
        BuddyDeckPanel created = new BuddyDeckPanel(BuddyTestAppearance.options(), deck, () -> layouts++);
    ...
    @Test void dismissingRefreshesTheLiveColumnAsWellAsTheDrawer() {
        post("a", "one");
        int[] notified = {0};
        BuddyDeckPanel connected = new BuddyDeckPanel(BuddyTestAppearance.options(), deck, () -> { }, () -> notified[0]++);
