...
class BuddyBubblePanelTest {
    ...
    @Test void aTitleOnlyMessageIsTheTextPlusPadding() {
        BuddyBubblePanel panel = new BuddyBubblePanel(BuddyTestAppearance.options());
        panel.setContent(BuddyBubbleContent.message(TITLE, null, null));
        FontMetrics metrics = panel.getFontMetrics(new BuddyBubblePanel(BuddyTestAppearance.options()).titleFont(BuddyBubbleContent.Style.MESSAGE));
    ...
    @Test void aMenuBubbleIsACompactRegularWeightPill() {
        BuddyBubblePanel menu = new BuddyBubblePanel(BuddyTestAppearance.options());
        menu.setContent(BuddyBubbleContent.menu(TITLE));
        java.awt.Font font = new BuddyBubblePanel(BuddyTestAppearance.options()).titleFont(BuddyBubbleContent.Style.MENU);
        assertThat(font.isBold()).isFalse();
        assertThat(font.getSize2D()).isLessThan(new BuddyBubblePanel(BuddyTestAppearance.options()).titleFont(BuddyBubbleContent.Style.MESSAGE).getSize2D());
        ...
        BuddyBubblePanel message = new BuddyBubblePanel(BuddyTestAppearance.options());
    ...
    @Test void aDetailLineAddsItsHeightAndAFourPixelGap() {
        BuddyBubblePanel titleOnly = new BuddyBubblePanel(BuddyTestAppearance.options());
        titleOnly.setContent(BuddyBubbleContent.message("Blocked", null, null));
        BuddyBubblePanel withDetail = new BuddyBubblePanel(BuddyTestAppearance.options());
        withDetail.setContent(new BuddyBubbleContent("Blocked", "Waiting", null));
        FontMetrics detail = withDetail.getFontMetrics(new BuddyBubblePanel(BuddyTestAppearance.options()).detailFont());
    ...
    @Test void aGlyphAddsItsWidthAndAGap() {
        ...
        BuddyBubblePanel plain = new BuddyBubblePanel(BuddyTestAppearance.options());
        plain.setContent(BuddyBubbleContent.message(wide, null, null));
        BuddyBubblePanel decorated = new BuddyBubblePanel(BuddyTestAppearance.options());
    ...
    @Test void theBubbleIsNeverNarrowerThanTheMinimumOrWiderThanTheMaximum() {
        BuddyBubblePanel narrow = new BuddyBubblePanel(BuddyTestAppearance.options());
        narrow.setContent(BuddyBubbleContent.message("Hi", null, null));
        assertThat(narrow.getPreferredSize().width).isEqualTo(120);
        BuddyBubblePanel wide = new BuddyBubblePanel(BuddyTestAppearance.options());
        ...
        BuddyBubblePanel longMenu = new BuddyBubblePanel(BuddyTestAppearance.options());
    ...
    @Test void theBubbleIsNotOpaque() {
        assertThat(new BuddyBubblePanel(BuddyTestAppearance.options()).isOpaque()).isFalse();
    }
    ...
    @Test void theBubbleUsesTheSystemFontRatherThanTheLookAndFeelsLabelFont() {
        assertThat(new BuddyBubblePanel(BuddyTestAppearance.options()).detailFont().getFamily())
            .isEqualTo(BuddyTestAppearance.options().primaryFont().deriveFont(java.awt.Font.PLAIN, 14f).getFamily());
    }
}
