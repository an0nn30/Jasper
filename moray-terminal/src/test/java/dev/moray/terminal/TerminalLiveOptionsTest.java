...
class TerminalLiveOptionsTest {
    ...
    void setUp() throws Exception {
        ...
        session = new TerminalSession(connector, 20, 6, 3);
    ...
    void typographyRefitsTheSameSessionAndManualSizeUsesLatestOptions() throws Exception {
        ...
        onEdt(() -> {
            ...
            assertThat(session.snapshot().lineText(0)).startsWith("hello");
            ...
            assertThat(view.options().palette()).isEqualTo(Palette.morayLight());
        });
    }
    ...
    void behaviorUpdatesAndEqualOptionsPreserveSelectionFindAndPendingInput() throws Exception {
        ...
        onEdt(() -> {
            selectFirstWord();
            assertThat(view.find("hello", false, true).count()).isOne();
        ...
        connector.feed("\r\n1\r\n2\r\n3\r\n4\r\n5\r\n6\r\n7\r\n8\r\n9");
        Await.until(() -> session.snapshot().lineText(5).equals("9"), "output after live update");
        assertThat(session.snapshot().historyLines()).isEqualTo(3);
    }
    ...
    void spacedMetricsDriveSelectionMouseReportsAndRenderedRows() throws Exception {
        ...
        Await.until(session::mouseReporting, "mouse reporting enabled");
    ...
    void configuredCursorUpdatesRespectProgramOverridesAndRis() throws Exception {
        ...
        try {
            ...
            connector.feed("\033c");
            Await.until(() -> session.snapshot().cursorShape() == null, "RIS clears program cursor override");
    ...
    private void show(String input, int row, String expected) throws Exception {
        ...
        Await.until(() -> session.snapshot().lineText(row).startsWith(expected), expected + " on screen");
    }
