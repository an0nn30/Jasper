...
final class TerminalTab extends JPanel implements AutoCloseable {
    ...
    java.util.List<TerminalPane> panes() { return java.util.List.copyOf(panes.values()); }
    ...
    void split(SplitTree.Axis axis) {
