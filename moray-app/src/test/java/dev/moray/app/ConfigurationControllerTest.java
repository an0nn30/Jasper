...
class ConfigurationControllerTest {
    ...
    void savedFieldsApplyAcrossOwnersAndPendingHiddenViewsWithoutReplacingSessions() throws Exception {
        ...
        edt(() -> {
            ...
            for (var pane : List.of(retained, first.currentPane(), second.currentPane())) {
                assertThat(pane.findBar().queryField().getUI().getClass().getName()).contains("Metal");
    ...
    void unrelatedChangesPreserveTemporaryChoicesAndNewOwnersUseSavedDefaults() throws Exception {
        ...
        edt(() -> {
            ...
            assertThat(first.status().isVisible()).isFalse(); assertThat(UIManager.getLookAndFeel().getID()).isEqualTo("Metal");
