 ...
 * <p>Allowed outgoing Jasper dependencies: dev.jasper.app.contributions, dev.jasper.app.notifications, dev.jasper.app.persistence, dev.jasper.app.platform, dev.jasper.app.terminals, dev.jasper.app.windows, dev.jasper.sdk, dev.jasper.sdk.activity, dev.jasper.sdk.events, dev.jasper.sdk.plugin, dev.jasper.sdk.services, dev.jasper.sdk.terminal, dev.jasper.sdk.ui, dev.jasper.terminal.session.
