...
final class WindowChrome {
    ...
    WindowChrome(WindowContent owner) {
        ...
        JMenu view = menu("View", ActionId.COMMAND_PALETTE, ActionId.HISTORY_PALETTE, ActionId.SNIPPETS_PALETTE, ActionId.ZOOM_PANE, ActionId.FONT_BIGGER, ActionId.FONT_SMALLER, ActionId.FONT_RESET);
        view.insertSeparator(3);
