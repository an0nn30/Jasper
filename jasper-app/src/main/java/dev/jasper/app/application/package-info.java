 ...
 * <p>Allowed outgoing Jasper dependencies: dev.jasper.app.appearance, dev.jasper.app.config, dev.jasper.app.history, dev.jasper.app.launch, dev.jasper.app.lifecycle, dev.jasper.app.notifications, dev.jasper.app.persistence, dev.jasper.app.platform, dev.jasper.app.plugins, dev.jasper.app.snippets, dev.jasper.app.windows, dev.jasper.app.workspace, dev.jasper.buddy.config, dev.jasper.buddy.view, dev.jasper.terminal.config, dev.jasper.terminal.rendering, dev.jasper.terminal.session.
