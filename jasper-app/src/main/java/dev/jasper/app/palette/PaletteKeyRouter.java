...
public final class PaletteKeyRouter implements AutoCloseable {
    ...
    public PaletteKeyRouter(PaletteController palette, java.util.function.Consumer<String> open, Supplier<KeyBindings> bindings, boolean macOs,
    ...
    public boolean dispatchTail(KeyEvent event) {
    ...
    public boolean dispatchShortcut(KeyStroke stroke, Component source) { return route(stroke, source, code -> {}); }
    ...
    public void reset() { swallowed.clear(); swallowTyped = false; }
    public boolean drained() { return swallowed.isEmpty(); }
