...
public final class SnippetsScope implements PaletteScope {
    ...
    public SnippetsScope(SnippetStore store, Consumer<String> onError) { this(store, onError, AppIcons.icon("bookmark")); }

    public SnippetsScope(SnippetStore store, Consumer<String> onError, Icon icon) {
