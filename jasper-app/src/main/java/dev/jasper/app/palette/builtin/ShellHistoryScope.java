...
import dev.jasper.app.history.ShellHistorySnapshot;
 ...
 */
public final class ShellHistoryScope implements PaletteScope {
    ...
    public ShellHistoryScope(ShellHistoryIndex index) { this(index, null, AppIcons.icon("history")); }

    public ShellHistoryScope(ShellHistoryIndex index, Icon icon) { this(index, null, icon); }

    public ShellHistoryScope(ShellHistoryIndex index, SnippetStore snippets, Icon icon) {
