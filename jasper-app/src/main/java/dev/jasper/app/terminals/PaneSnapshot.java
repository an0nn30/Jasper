...
/** What a pane reports about itself at one moment. The grid is zero by zero until the session starts; {@code providerId} names who provides a session that is not a local shell. */
