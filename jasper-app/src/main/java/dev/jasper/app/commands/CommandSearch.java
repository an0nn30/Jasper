...
public final class CommandSearch {
    ...
    public record Entry(Command command, String title, List<String> words, String keywords) {}
    ...
    public static List<Command> find(List<Entry> entries, String query, List<String> recent, int limit) {
