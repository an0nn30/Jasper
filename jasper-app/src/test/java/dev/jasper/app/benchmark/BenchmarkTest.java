...
class BenchmarkTest {
    ...
    @Test void stagedUtf8WorkloadIsSeededAndCountsActualBytes() throws Exception {
        ...
        assertThat(Files.readString(first)).contains("\033[", "jasper");
    }
    ...
    @Test void childArgumentsKeepPathsWithSpacesAndMetacharactersSeparate() {
        ...
        assertThat(command).containsSubsequence("dev.jasper.app.benchmark.BenchmarkFixture", "--data", directory.resolve("data.txt").toString(),
