...
public final class ShellRun {
    public static final String A = "\033]133;A\007";
    public static final String B = "\033]133;B\007";
    public static final String C = "\033]133;C\007";
    public static String D(int status) { return "\033]133;D;" + status + "\007"; }
    public static String CMD(String command) {
        return "\033]1341;jasper;cmd;" + Base64.getEncoder().encodeToString(command.getBytes(StandardCharsets.UTF_8)) + "\007";
    }
    public static String CWD(String host, String encodedPath) { return "\033]7;file://" + host + encodedPath + "\007"; }

    private ShellRun() {}

    public static String run(List<String> command, Map<String, String> environment, Path directory, String input)
    ...
    public record Result(String output, String errors) {}

    /** As {@link #run}, but without merging stderr, so warnings from the shell itself are visible on their own. */
    public static Result runSeparate(List<String> command, Map<String, String> environment, Path directory, String input)
            throws IOException, InterruptedException {
    ...
    public static String hostname() throws IOException, InterruptedException {
