...
final class SnippetFile {
    public static final String HEADER = "# Jasper snippets. Edit freely; Jasper only ever appends new [[snippet]] tables.\n";
    ...
    public static String append(String existing, Snippet snippet) {
